...
if (scheme == 'ocd-theme-1') {
	$("body").removeClass();
	$("body").addClass("ocd-theme-1");
}
else if (scheme == 'ocd-theme-2') {
	$("body").removeClass();
	$("body").addClass("ocd-theme-2");
}
else if (scheme == 'ocd-theme-3') {
	$("body").removeClass();
	$("body").addClass("ocd-theme-3");
}
else if (scheme == 'ocd-theme-4') {
	$("body").removeClass();
	$("body").addClass("ocd-theme-4");
}
else if (scheme == 'ocd-theme-5') {
	$("body").removeClass();
	$("body").addClass("ocd-theme-5");
}
else if (scheme == 'ocd-theme-6') {
	$("body").removeClass();
	$("body").addClass("ocd-theme-6");
}
...
$("#cmdRed").click(function(){
	...
	$.cookie('scheme', 'ocd-theme-1', { expires:date});
	scheme = "ocd-theme-1";
	return false;
});
$("#cmdViolet").click(function(){
	...
	$("body").addClass("ocd-theme-2");
	checkAsideMenuVisibility();
	$.cookie('scheme', 'ocd-theme-2', { expires:date});
	scheme = "ocd-theme-2";
	return false;
});
$("#cmdBlue").click(function(){
	...
	$("body").addClass("ocd-theme-3");
	checkAsideMenuVisibility();
	$.cookie('scheme', 'ocd-theme-3', { expires:date});
	scheme = "ocd-theme-3";
	return false;
});
$("#cmdGreen").click(function(){
	...
	$("body").addClass("ocd-theme-4");
	checkAsideMenuVisibility();
	$.cookie('scheme', 'ocd-theme-4', { expires:date});
	scheme = "ocd-theme-4";
	return false;
});
$("#cmdYellow").click(function(){
	...
	$("body").addClass("ocd-theme-5");
	checkAsideMenuVisibility();
	$.cookie('scheme', 'ocd-theme-5', { expires:date});
	scheme = "ocd-theme-5";
	return false;
});
$("#cmdOrange").click(function(){
	...
	$("body").addClass("ocd-theme-6");
	checkAsideMenuVisibility();
	$.cookie('scheme', 'ocd-theme-6', { expires:date});
	scheme = "ocd-theme-6";
	return false;
});
